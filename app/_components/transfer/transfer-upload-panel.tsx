...
export function TransferUploadPanel({
  ...
  return (
    <section className="w-full max-w-sm">
      ...
      >
        <span className="relative flex h-[80px] w-[80px] shrink-0 items-center justify-center overflow-hidden rounded-full bg-[radial-gradient(circle_at_top,rgba(255,255,255,0.20),rgba(255,255,255,0.04)_58%),rgba(0,0,0,0.32)]">
          {!recentImageUrl ? (
            <svg
          ...
          {recentImageUrl ? (
            ...
            <span className="absolute inset-0 z-10 flex items-center justify-center text-center text-[18px] font-semibold leading-none text-white">
              {uploadProgress}%
            </span>
          ) : (
            <PlusIcon className="absolute inset-0 z-10 m-auto h-[32px] w-[32px] text-white" />
          )}
        </span>
